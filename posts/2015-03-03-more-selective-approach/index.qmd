...
date: "2015-03-03"
categories: [effect sizes, graphs, simplicity]
---
...
many of which are irrelevant to the authors' research question (e.g. [here](../2014-09-26-balance-tests) and [here](../2014-10-15-tautological-tests)).
...
* I've written about standardised effect sizes (here: Hedges' _g_) [before](../2015-02-05-standardised-vs-unstandardised-es), 
...
* If the reading times weren't measured with centisecond accuracy, keeping only two significant figures may be [better](../2015-01-14-overaccuracy).
...
![](../../figs/2015-03-03-more-selective-approach/unnamed-chunk-1-1.png) 
...
![](../../figs/2015-03-03-more-selective-approach/unnamed-chunk-2-1.png) 
