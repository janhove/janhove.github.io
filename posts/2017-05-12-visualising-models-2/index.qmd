...
date: "2017-05-12"
categories: [R, graphs, logistic regression, mixed-effects models, multiple regression, tutorial]
execute:
  cache: true
---

In the 
[previous](../2017-04-23-visualising-models-1)
...
[previous](../2017-04-23-visualising-models-1) post,
...
Or if you want to be more precise, a 
[**pointwise** confidence band](https://en.wikipedia.org/wiki/Confidence_and_prediction_bands#Pointwise_and_simultaneous_confidence_bands).
...
See the [previous](../2017-04-23-visualising-models-1)
