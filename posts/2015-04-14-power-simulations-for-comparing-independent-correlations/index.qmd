...
date: "2015-04-14"
categories: [significance, power, R]
---

Every now and then, researchers want to compare the strength of a correlation between two samples or studies.
Just establishing that one correlation is significant while the other isn't 
[doesn't work](../2014-10-28-assessing-differences-of-significance) -- 
...
```{r, cache = TRUE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 12, fig.width = 4}
library(MASS)
library(psych)
...
results40 <- outer(corrs, corrs, 
                   function(x, y) mapply(compute.power, 
                                         popr12 = x, popr34 = y, 
                                         n1 = 40, n2 = 40, 
                                         n.sims = nsims))

results80 <- outer(corrs, corrs, 
                   function(x, y) mapply(compute.power, 
                                         popr12 = x, popr34 = y, 
                                         n1 = 80, n2 = 80, 
                                         n.sims = nsims))
...
contour(x = corrs, y = corrs, z = results40, nlevels = 10, 
        labcex = 0.9, col = "gray26", at = seq(-1, 1, 0.2),
        main = "n = 40 in both samples",
        xlab = "Correlation in population A",
        ylab = "Correlation in population B")
abline(v = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
abline(h = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
contour(x = corrs, y = corrs, z = results40, levels = 0.80, 
        drawlabels = FALSE, at = seq(-1, 1, 0.2),
        add = TRUE, lwd = 3, col = "steelblue3")

contour(x = corrs, y = corrs, z = results80, nlevels = 10, 
        labcex = 0.9, col = "gray26", at = seq(-1, 1, 0.2),
        main = "n = 80 in both samples",
        xlab = "Correlation in population A",
        ylab = "Correlation in population B")
abline(v = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
abline(h = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
contour(x = corrs, y = corrs, z = results80, levels = 0.80, 
        drawlabels = FALSE, at = seq(-1, 1, 0.2),
        add = TRUE, lwd = 3, col = "steelblue3")
par(mfrow = c(1, 1))
```
...
```{r, cache = TRUE, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 4, fig.width = 4}
library(MASS)
library(psych)
...
nsims <- 1000
results15_40 <- outer(corrs, corrs, 
                   function(x, y) mapply(compute.power, 
                                         popr12 = x, popr34 = y, 
                                         n1 = 15, n2 = 40, 
                                         n.sims = nsims))

contour(x = corrs, y = corrs, z = results15_40, nlevels = 10, 
        labcex = 0.9, col = "gray26", at = seq(-1, 1, 0.2),
        main = "n = 15 in A and n = 40 in B",
        xlab = "Correlation in population A",
        ylab = "Correlation in population B")
abline(v = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
abline(h = seq(-1, 1, 0.2), lwd = 1, col = "lightgray", lty = 2)
contour(x = corrs, y = corrs, z = results15_40, levels = 0.80, 
        drawlabels = FALSE, at = seq(-1, 1, 0.2),
        add = TRUE, lwd = 3, col = "steelblue3")
```
