...
date: "2015-03-16"
categories: [effect sizes, power, measurement error]
---

A couple of weeks ago, I outlined four reasons 
[why I don't like standardised effect sizes](../2015-02-05-standardised-vs-unstandardised-es) 
such as Cohen's _d_ or Pearson's _r_ and prefer raw effect sizes instead.
...
```{r, echo = FALSE}
par(las = 1, bty = "n")
curve(dnorm(x, mean = 82.1, sd = 3),
      xlab = "Measured value",
      ylab = "Density",
      main = "Distribution with different measurement errors",
      from = 82.1-25, to = 82.1+25)

curve(dnorm(x, mean = 82.1, sd = 3.2), 
      add = TRUE, col = "blue")

curve(dnorm(x, mean = 82.1, sd = 6.7), 
      add = TRUE, col = "red")

legend(x = "topright",
       legend = c("no m. error", "low m. error", "high m. error"),
...
curve(dnorm(x, mean = 82.1, sd = 6.7), 
      add = FALSE, col = "red",
      xlab = "Measured value", ylab = "Density",
      main = "High measurement error",
      from = 82.1-25, to = 82.1+25)
abline(v = 82.1)

curve(dnorm(x, mean = 82.1-4, sd = 6.7), 
...
curve(dnorm(x, mean = 82.1, sd = 3.2), 
      add = FALSE, col = "blue",
      xlab = "Measured value", ylab = "Density",
      main = "Low measurement error",
      from = 82.1-25, to = 82.1+25)
abline(v = 82.1)

curve(dnorm(x, mean = 82.1-4, sd = 3.2), 
...
(I've focused on measurement error here, but standardised effect sizes are also affected by
[other design features](../2015-02-05-standardised-vs-unstandardised-es).)
