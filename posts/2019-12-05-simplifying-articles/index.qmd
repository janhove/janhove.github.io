...
date: "2019-12-05"
categories: [simplicity, silly tests, graphs, cluster-randomised experiments, open science]
---
...
[Overprecise reporting](../2015-01-14-overaccuracy) 
...
* [Tutorial: Drawing a scatterplot](../2016-06-02-drawing-a-scatterplot)
* [Tutorial: Drawing a line chart](../2016-06-13-drawing-a-linechart)
* [Tutorial: Drawing a boxplot](../2016-06-21-drawing-a-boxplot)
* [Tutorial: Drawing a dot plot](../2016-08-30-drawing-a-dotplot)
* [Tutorial: Plotting regression models](../2017-04-23-visualising-models-1)
* [Visualising statistical uncertainty using model-based graphs](../../visualise_uncertainty/)
...
As I’ve written [before](../2016-02-23-uninteresting-main-effects), it’s only the interaction that’s of any interest here, and exactly the same p-value can be obtained using a simpler method:
