...
As I've 
[written](../2015-02-05-standardised-vs-unstandardised-es) 
[before](../2015-03-16-standardised-es-revisited), 
...
**Update (2023-08-07):** I reran all of the code in this blog post
...
90% confidence interval for Cohen's _d_: [0.25, 1.37].
...
90% confidence interval for Hedges' _g_: [0.25, 1.34].

(Incidentally, `cohen.d` also has a parameter called `noncentral`, 
but setting it to `TRUE` doesn't seem to work... (**Update (2023-08-07):** It does now.))
...
Here, I'm only interested in Cohen's _d_, whose 90% confidence interval now is [0.27, 1.35]. 
