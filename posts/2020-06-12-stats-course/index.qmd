...
date: "2020-06-12"
categories: [measurement error, logistic regression, correlational studies, mixed-effects models, multiple regression, predictive modelling, research questions, contrast coding, reliability]
---
...
[blogged](../2020-05-05-contrast-coding) 
...
out of hand when working with binary data. A related blog post is [_Interactions in logistic regression models_](../2019-08-07-interactions-logistic).
