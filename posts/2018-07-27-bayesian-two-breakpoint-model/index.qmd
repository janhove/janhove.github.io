...
date: "2018-07-27"
categories: [R, piecewise regression, non-linearities, Bayesian statistics, Stan]
execute: 
  cache: true
---

In this follow-up to the blog post [_Baby steps in Bayes: Piecewise regression_](../2018-07-04-bayesian-breakpoint-model), 
...
**Update (2023-08-06):** When I reran the code in this blog post
using newer versions of Stan and R, I ran into serious convergence
issues. I have pulled down this blog post till I figure out how to 
fix these.

```{r, fig.width = 6, fig.height = 4, echo = FALSE}
#| fig.cap: "**Figure 1.** The underlying form of the x-y relationship is characterised by two breakpoints. The function's three pieces are connected to each other."
# Parameters
a <- 4
c <- 12
b <- 0.2
...
t1 <- 4.3
t2 <- 13.6
f <- ((c+d*t2) - (a+b*t1))/(t2-t1)
e <- (a*t2 + b*t1*t2 - c*t1 - d*t1*t2)/(t2-t1)
...
plot(x, y, type = "l")
segments(x0 = t1, y0 = 0, y1 = a+b*t1, lty = 2)
segments(x0 = t2, y0 = 0, y1 = c+d*t2, lty = 2)
```
