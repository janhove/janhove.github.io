...
date: "2020-05-23"
categories: [R, contrast coding, mixed-effects models, multiple regression, tutorial, research questions]
---
...
For the second and third example, I'll use data from Pestana et al. (2018), who measured the Portuguese reading skills of Portuguese children in Portugal, French-speaking Switzerland, and German-speaking Switzerland at three points in time. The data are available as part of the [`helascot` package](https://github.com/janhove/helascot).
