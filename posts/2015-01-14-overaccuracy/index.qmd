...
I don't doubt that this is an accurate description of Bayard's findings, which appeared in the 1995 volume of the [_New Zealand English Newsletter_](http://www.arts.canterbury.ac.nz/linguistics/nzej/nzejback-issues.shtml) (**Update (2023-08-26):** Link broken.).
Quite the contrary: I think it's _too_ accurate a description of his research findings.
**Overaccuracy** is only a minor pet peeve of mine, but it ties in with my feeling that we can do with [fewer](../2014-10-15-tautological-tests) [tests](../2014-09-26-balance-tests) when reporting research findings, so here goes.
