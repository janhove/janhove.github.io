...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 1.5, fig.height = 1.2}
#| fig.cap: "**Figure 1.1.** The causal links between `x`, `y` and `z` in Case 1."
posttreatment1 <- dagitty("dag {
   x -> y
   x -> z
}")
coordinates(posttreatment1) <- list(
  y = c(x = 1, y = 2, z = 0),
  x = c(x = 0, y = 1, z = 1)
)
drawdag( posttreatment1 )
```
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 1.2.** Graphical analysis without the covariate for Case 1."
library(tidyverse)
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 1.3.** Graphical analysis with the covariate (median split) for Case 1."
ggplot(data = df_case1,
       aes(x = x, y = y)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitter(width = 0.2), pch = 1) +
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 1.4.** In Case 1, the distribution of the parameter estimates is centred around the correct value both when the control variable is taken into account and when it isn't. The distribution is wider when taking the control variable into account, however, i.e., the estimates are less precise when taking the control variable into account than when not taking it into account."
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 1.5, fig.height = 1.2}
#| fig.cap: "**Figure 2.1.** The causal links between `x`, `y` and `z` in Case 2."
posttreatment2 <- dagitty("dag {
   x -> y -> z
}")
coordinates(posttreatment2) <- list(
  y = c(x = 0, y = 0, z = 0),
  x = c(x = 0, y = 1, z = 2)
)
drawdag( posttreatment2 )
```
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 2.2.** Graphical analysis without the covariate for Case 2."
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 2.3.** Graphical analysis with the covariate for Case 2."
ggplot(data = df_case2,
       aes(x = x, y = y)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitter(width = 0.2), pch = 1) +
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 2.4.** In Case 2, the distribution of the parameter estimates is centred around the correct value both when the control variable isn't taken into account but it is strongly biased when this control variable *is* taken into account, i.e., the analysis with the covariate yields biased estimates."
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 1.5, fig.height = 1.2}
#| fig.cap: "**Figure 3.1.** The causal links between `x`, `y` and `z` in Case 3."
posttreatment3 <- dagitty("dag {
   x -> y -> z
   x -> z
}")
coordinates(posttreatment3) <- list(
  y = c(x = 1, y = 2, z = 0),
  x = c(x = 0, y = 1, z = 1)
)
drawdag( posttreatment3 )
```
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 3.2.** Graphical analysis without the covariate for Case 3."
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 3.3.** Graphical analysis with the covariate for Case 3."
ggplot(data = df_case3,
       aes(x = x, y = y)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitter(width = 0.2), pch = 1) +
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 3.4.** In Case 3, too, the distribution of the parameter estimates is centred around the correct value when the control variable isn't taken into account but it is strongly biased when this control variable *is* taken into account, i.e., the analysis with the covariate yields biased estimates."
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 1.5, fig.height = 1.2}
#| fig.cap: "**Figure 4.1.** The causal links between `x`, `y` and `z` in Case 4."
posttreatment4 <- dagitty("dag {
   x -> z -> y
   x -> y
}")
coordinates(posttreatment4) <- list(
  y = c(x = 1, y = 2, z = 0),
  x = c(x = 0, y = 1, z = 1)
)
drawdag( posttreatment4 )
```
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 4.2.** Graphical analysis without the covariate for Case 4."
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 4.3.** Graphical analysis with the covariate for Case 4."
ggplot(data = df_case4,
       aes(x = x, y = y)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitter(width = 0.2), pch = 1) +
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 4.4.** In Case 4, the analysis without the covariate correctly estimates the *total* causal influence that `x` has on `y`, while the analysis with the covariate correctly estimates the *direct* causal effect of `x` on `y`. Either may be relevant, but you have to know which!"
...
```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 1.5, fig.height = 1.2}
#| fig.cap: "**Figure 5.1.** The causal links between `x`, `y` and `z` in Case 5."
posttreatment5 <- dagitty("dag {
   x -> y
   z -> y
}")
coordinates(posttreatment5) <- list(
  y = c(x = 1, y = 2, z = 0),
  x = c(x = 0, y = 1, z = 1)
)
drawdag( posttreatment5 )
```
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 5.2.** Graphical analysis without the covariate for Case 5."
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 5.3.** Graphical analysis with the covariate for Case 5."
ggplot(data = df_case5,
       aes(x = x, y = y)) +
  geom_boxplot(outlier.shape = NA) +
  geom_point(position = position_jitter(width = 0.2), pch = 1) +
...
```{r, echo = TRUE, eval = TRUE, cache = FALSE, fig.width = 9, fig.height = 4.5}
#| fig.cap: "**Figure 5.4.** In Case 5, both analyses are centred around the correct value, i.e., both are unbiased. The analysis with the control variable yields a narrower distribution of estimates, however, i.e., it is more precise."
