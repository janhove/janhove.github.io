...
<!--more-->
 ...
 Both questions are [uninteresting](https://doi.org/10.14746/ssllt.2015.5.1.7) 
 ...
 Sometimes, a good graph will allow you to carry out the easiest of significance tests yourself: the ['inter-ocular trauma test'](https://www.johndcook.com/blog/2009/08/31/the-iot-test/)--if the conclusion hits you between the eyes, it's significant.
 ...
 [balance tests](../2014-09-26-balance-tests) in randomised experiments 
 (e.g. _The control and intervention group did not differ in terms of SES (t(36) = 0.8, p = 0.43)._),
 [tautological tests](../2014-10-15-tautological-tests)
 ...
 as well as some [less obvious cases](../2015-06-08-unrelated-tests).
 ...
 then you can [ignore the tests for the main effects](../2016-02-23-uninteresting-main-effects).  
 ...
 7. **Ask yourself some critical questions.**  
      ...
      If the paper reports on a [cluster-randomised experiment](../2015-09-17-cluster-randomised-experiments) 
      ...
      has its [problems](../2015-10-16-nonlinear-relationships) on the statistical side.
      ...
      [interpreting 'no significant difference' to mean 'equal'](https://psycnet.apa.org/doi/10.1037/1082-989X.1.2.115),
      [interpreting differences in significance](../2014-10-28-assessing-differences-of-significance) and
