---
title: "Kursangebote und Beratung"
toc: true
toc-depth: 4
---
...
Die Kurse vermitteln allgemeine Prinzipien, 
wie quantitative Daten aufbereitet und analysiert werden können. 
Diese Prinzipien sind sowohl für neue 
als auch für routinierte Forschende relevant. 
Sie werden in den Kursen anhand von Datensätzen illustriert, 
die ich den Teilnehmenden zur Verfügung stelle. 
Möchten Sie eigene Datensätze der Kursteilnehmenden analysieren, 
eignen sich die Formate
[Sprechstunden](#sprechstunden) 
und [Methoden- und Statistikberatung](#beratung) 
besser.
...
### Beratung und Datenanalyse {#beratung}
Wenn Sie punktuell individuelle Methoden- oder Statistikberatung suchen
oder mich für die Datenanalyse Ihres Projektes in Anspruch nehmen möchten,
